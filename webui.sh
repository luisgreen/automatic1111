...
cp /tmp/launch.py /opt/AUTOMATIC1111/stable-diffusion-webui/launch.py

printf "\n%s\n" "${delimiter}"
printf "Installing xformers, triton, torch..."
printf "\n%s\n" "${delimiter}"
"${venv_dir}"/bin/python -m pip install --upgrade xformers==0.0.23.post1 triton==2.1.0 torch==2.1.2
